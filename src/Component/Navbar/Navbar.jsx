...
export const Navbar = () => {
  let { model, openModel, user, loader ,logout , showpostform,showcreate } = useContext(contextprovider);
  let openlogin = () => {
    openModel();
  };
  const userlogout = ()=>{
  ...
  const checkuser = () => {
    return  (
      <>
      {!loader ? !loader && user ? (
      <li onClick={userlogout} onMouseUp={openlogin}>
        <span><PermIdentityIcon /></span>
        <span>{user.displayName}/ <span >Logout</span></span>
      </li>
    ) : (
  ...
  return (
    <>
      <div
        className="Navbar px-4 pt-4"
        style={model ? { zIndex: -1 } : { zIndex: 1 }}
      >
        <div className="logo d-none d-md-block">
          <img src={Logo} className="d-xl-inline-block d-none" alt="logo"/>
          <span className="d-xl-none d-inline-block">
            <svg
        ...
        <div className="options d-none d-md-block">
          <li>
            <span>
              <svg
                aria-label="Settings"
      ...
      <div
        className="searchnav d-md-none p-4 "
        style={model ? { zIndex: -1 } : { zIndex: 1 }}
      >
        <div className="logo">
